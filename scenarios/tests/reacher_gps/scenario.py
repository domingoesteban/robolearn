...
from robolearn.old_policies.lin_gauss_init import init_pd, init_dual_demos, init_lqr
    ...
    def create_agent(self):
        ...
        policy_params = {
            ...
            'network_params': {
                ...
                'dim_hidden': [100, 100],  # [32, 32] # List of size per n_layers
            ...
            'batch_size': 32,  # 15
            'lr': 1e-4,  #1e-3 # Base learning rate (by default it's fixed).
