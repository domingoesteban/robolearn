...
from robolearn.policies.lin_gauss_init import init_pd, init_dual_demos, init_lqr, init_pd_tgt
...
from robolearn.policies.dataset_policy import DataSetPolicy
    ...
    def create_init_conditions(self):
        ...
        if bool(self.task_params['fix_init_conds']):
            ...
            for cc, cond in enumerate(initial_cond):
                ...
                cond_idx = 2*self.env.get_action_dim()
                data_idx = self.env.get_action_dim() # We now this is 3
