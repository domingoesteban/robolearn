...
import numpy as np
from robolearn.old_envs.centauro.centauro_drill_env import CentauroDrillEnv
...
class Scenario(object):
    ...
    def create_init_conditions(self):
        ...
        for cc, cond in enumerate(initial_cond):
            ...
            # env_condition[:self.env.get_action_dim()] = np.deg2rad(cond[:self.env.get_action_dim()])
