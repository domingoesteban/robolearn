...
def create_hand_relative_pose(drill_pose, hand_x=0.0, hand_y=0.0, hand_z=0.0, hand_yaw=0):
    """
...
def generate_reach_joints_trajectories(drill_relative_pose, drill_size, T, q_init, option=0, dt=1):
    ...
    LH_reach_pose = create_hand_relative_pose(drill_relative_pose, hand_x=0, hand_y=drill_size[1]/2-0.02, hand_z=0, hand_yaw=0)
    RH_reach_pose = create_hand_relative_pose(drill_relative_pose, hand_x=0, hand_y=-drill_size[1]/2+0.02, hand_z=0, hand_yaw=0)
    N = int(np.ceil(T/dt))
