...
gps_directory_name = 'test_log_dir'
...
gps_path = '/home/domingo/robotlearning-workspace/learning-modules/robolearn/scenarios/dualist_gps/' \
           + gps_directory_name
...
if not pol_sample_lists_costs:
    print('Empty sample lists. There is not sample costs. Is the path correct?')
    exit(-1)
