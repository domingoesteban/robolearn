...
# PAPER
gps_directory_names = ['test_log_dir']
gps_models_labels = ['dualist_gps']
...
for gps, gps_directory_name in enumerate(gps_directory_names):
    gps_path = '/home/domingo/robotlearning-workspace/learning-modules/robolearn/scenarios/dualist_gps/' + gps_directory_name
