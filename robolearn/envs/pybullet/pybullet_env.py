...
try:
    ...
    raise error.DependencyNotInstalled("{}. (HINT: you need to install pybullet: pip install pybullet)".format(e))


class PybulletMujocoEnv(gym.Env):
    """Superclass for all Pybullet environments.
    """
    def __init__(self, model_path, frame_skip, renders):
    ...
    def _reset(self):
        ...
        self.my_pybullet.resetSimulation()
        ob = self.reset_model()
