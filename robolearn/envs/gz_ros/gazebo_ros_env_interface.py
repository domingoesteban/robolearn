...
from robolearn.utils.iit.xbot_ros import update_xbot_command
...
class GazeboROSEnvInterface(ROSEnvInterface):
    def __init__(self, robot_name=None, mode='simulation', joints_active=None,
                 urdf_file=None, action_active=None,
