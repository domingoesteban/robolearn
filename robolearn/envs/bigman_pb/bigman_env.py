...
from robolearn.envs.bigman_pb.bigman_robot import BigmanBulletRobot

from robolearn.envs.pybullet.bullet_env import BulletEnv


class BigmanBulletEnv(BulletEnv):
    metadata = {
    ...
    def __init__(self, render=False):
        ...
        # init_pos = [0, 0, 1.05]
        init_pos = [0, 0, 1.041]
        self._robot = BigmanBulletRobot(init_pos=init_pos, control_type='position')
        ...
        super(BigmanBulletEnv, self).__init__(gravity=gravity, sim_timestep=sim_timestep, frameskip=frame_skip,
                                              render=render)
    ...
    def reset_model(self):
        ...
        pb.resetBasePositionAndOrientation(self.table_uid[-1], (.7, 0, 0.001), (0, 0, 0, 1))
        ...
        # pos, ori = pb.getBasePositionAndOrientation(ii)
        pb.resetBasePositionAndOrientation(self.drill_uid[-1], (.7, 0, 1.147), (0, 0, 0, 1))
