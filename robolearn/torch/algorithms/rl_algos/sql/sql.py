...
from robolearn.torch.algorithms.rl_algos.sql.kernel import adaptive_isotropic_gaussian_kernel
...
class SQL(TorchIncrementalRLAlgorithm):
    """Soft Q-learning (SQL).
