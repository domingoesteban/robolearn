...
class TanhGaussianWeightedMultiPolicy2(PyTorchModule, ExplorationPolicy):
    """
    Usage:
    ...
    def __init__(
        ...
        super(TanhGaussianWeightedMultiPolicy2, self).__init__()
    ...
    def forward(
        ...
        # TODO: TEMPORALLY: NOT DOING THIS
        ...
        if pol_idx is None:
            ...
            # log_std = \
            #     logsumexp(log_stds + log_mixture_coeff.reshape(-1, self.action_dim, self._n_policies), dim=-1,
            #               keepdim=False) \
