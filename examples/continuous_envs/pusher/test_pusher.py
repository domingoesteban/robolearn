...
# register(
#     id='PusherBullet-v5',
#     entry_point='robolearn.envs.pusher.pusher_env:PusherBulletEnv')


from robolearn.envs.pusher import PusherBulletEnv
from robolearn.agents.random_gym_agent import RandomGymAgent
...
if __name__ == '__main__':
    ...
    env = PusherBulletEnv(render=False, obs_with_img=env_with_img, obs_mjc_gym=obs_like_mjc, ntargets=ntargets,
