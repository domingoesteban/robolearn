...
from robolearn.envs.reacher import ReacherMultiBulletEnv
...
if __name__ == '__main__':
    ...
    env = ReacherMultiBulletEnv(render=False, obs_with_img=env_with_img, obs_mjc_gym=obs_like_mjc, ntargets=ntargets,
