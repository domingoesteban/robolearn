"""
Run PyTorch HIU-SAC on Navigation2dGoalCompoEnv.
...
expt_params = dict(
    ...
    algo_params=dict(
        ...
        i_entropy_scale=2.0e-0,
        u_entropy_scale=[5.0e-1, 5.0e-1],
        # Learning rates
        optimizer=OPTIMIZER,
        i_policy_lr=1.e-4,
        u_policies_lr=1.e-4,
        ...
        i_policy_mixing_coeff_weight=0.e+0,
        ...
        i_v_weight_decay=0.e-5,
        u_v_weight_decay=0.e-5,
    ...
    # final_pol_output_activation=True,
    # NN Activations
    # --------------
...
def experiment(variant):
    ...
    if variant['load_dir']:
        ...
        policy = POLICY(
            ...
            unshared_policy_hidden_sizes=[net_size, net_size],
            stds=None,
            ...
            final_policy_layer_norm=variant['final_policy_layer_norm'],
            reparameterize=REPARAM_POLICY,
