"""
Run PyTorch IU-Multi-SAC on Reacher2D3DofEnv.
...
from robolearn.torch.algorithms.rl_algos.sac.hiu_sac_episodic \
    import HIUSACEpisodic
...
expt_params = dict(
    algo_name=HIUSACEpisodic.__name__,
...
if __name__ == "__main__":
    ...
    copyfile(dir_filename, os.path.join(args.log_dir, filename))
