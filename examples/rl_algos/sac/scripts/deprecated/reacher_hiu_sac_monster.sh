...
env_name='reacher'
algo_name='hiu_sac_monster'
dir_prefix=${algo_name}_0sha_elu_mix

python_script=${env_name}'_'${algo_name}
log_dir_path='/home/local/IIT/desteban/logs/'${expt_name}'/'${env_name}'/'

#default_seeds=(610 710 810 910 1010)
default_seeds=(610 1010 710 810)
seeds=("${@:-${default_seeds[@]}}")
total_seeds=${#seeds[@]}
#init_index=0
#end_index=3
...
#    script_index=$((index+init_index))
    ...
    --log_dir ${log_dir} --expt_name ${env_name} --mix_weight ${mix_weight}
done
done
done
