...
from robolearn.torch.sac.iu_multisac import IUMultiSAC

from robolearn.torch.sac.value_functions import NNMultiQFunction, NNMultiVFunction
...
def experiment(variant):
    ...
    i_policy = WeightedTanhGaussianMultiPolicy(u_policy,
